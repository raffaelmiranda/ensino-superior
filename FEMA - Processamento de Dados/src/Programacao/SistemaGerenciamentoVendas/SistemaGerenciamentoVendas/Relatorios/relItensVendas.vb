...
Public Class relItensVendas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SistemaGerenciamentoVendas.relItensVendas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrelItensVendas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As relItensVendas = New relItensVendas
        rpt.Site = Me.Site
        Return rpt
    End Function
